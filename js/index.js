$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字是林智，来自福建</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我是一名前端工程师</div>",2000);
	...
	w.load("<p><div class='writecode'>林智</div>");
	w.load("<div class='writecode'>前端工程师</div>");
	w.load("<div class='writecode'>一年工作经验</div>");
	w.load("<div class='writecode'>现居广州</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:linzhi6121161@163.com</li>");
	w.load("<li class='writecode'>phone:15750889260</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>熟练使用Javascript</li>");
	w.load("<li class='writecode'>熟练掌握jQuery框架，了解jQuery原理</li>");
	w.load("<li class='writecode'>熟练掌握HTML/CSS前端开发技术以及标准化的HTML5/CSS3新特性，熟悉W3C标准，了解各个流浏览器特性，使页面兼容各个浏览器</li>");
	w.load("<li class='writecode'>熟悉掌握Ajax/Jsonp数据交互技术</li>");
	w.load("<li class='writecode'>熟练使用Flex布局，Sass 等CSS预处理器工具</li>");
	w.load("<li class='writecode'>熟练使用git版本管理工具，gulp、webpack等前端工程构建工具，npm包管理工具对项目进行团队开发</li>");
	w.load("<li class='writecode'>熟练掌握vue-cli进行vue单页面应用程序的开发，可独立开发其常用组件</li>");
	w.load("<li class='writecode'>熟练掌握bootstrap</li>");
	w.load("<li class='writecode'>熟练掌握zepto,Animate.css等框架</li>");
	w.load("<li class='writecode'>了解使用ES6语法</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='http://www.zuoshiyihetang.com' target='_blank'>www.zuoshiyihetang.com</a></li>");
	w.load("<li class='writecode'><a href='http://m.guojingold.com' target='_blank'>m.guojingold.com</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ:375917813</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:15750889260</div>");
